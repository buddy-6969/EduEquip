...
namespace EduEquip
{
    public partial class MainPage : ContentPage
    {
        ...
        private Dictionary<string, string> facultyAccounts = new Dictionary<string, string>
        {
            { "FAC001", "faculty123" },
            { "FAC002", "faculty123" }
        };
        ...
        private async void OnLoginClicked(object sender, EventArgs e)
        {
            ...
            if (facultyAccounts.TryGetValue(schoolId, out string facultyPassword) && facultyPassword == password)
            {
                await Navigation.PushAsync(new FacultyDashboard(schoolId));
                return;
            }
